...
| :--- | :--- |
| Audio | .wav, .aiff, .m4a, .mp3<sup class="footnote-ref">1</sup> *(96khz, 24bit is our archival target; however 48khz, 24bit, or as close to the archival standard as possible will be accepted)* |
| Video | .mts (AVCHD), .avi, .mov, .m4v, .dv, .mpg<sup class="footnote-ref">1</sup> |
| Images<sup class="footnote-ref">2</sup> | .tif, .jpg, .png, .CR2 |
...
| Lexicons | .xml, .txt, .pdf, .fwbackup<sup class="footnote-ref">3</sup> *(containing no media files)* |
...
* A good resolution setting is the <strong>full HD</strong> setting of <strong>1080p</strong>: WIDTH 1920 pixels x HEIGHT 1080 pixels. This gives you the aspect ratio of 16:9. Other settings include: a <strong>mid-range</strong> definition of <strong>720p</strong>: 1280x720 with a 16:9 aspect ratio.  A <strong>standard</strong> definition resolution of <strong>480p</strong>: 640x480 with the aspect ratio of 4:3. 
