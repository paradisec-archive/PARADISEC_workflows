...
The above 72 DPI <em>(dots per inch)</em> figure for the raw image is not very revealing as to the image quality compared to the 400 or 300 DPI figures. Image quality actually has more to do with pixel dimension. If you wish to read up on why DPI can be a tricky standard, take a look at this article: <a href="http://www.rideau-info.com/photos/mythdpi.html" target="_blank">The myth of DPI</a>.

There will be more about target image sizes (pixel dimension) below in the section on workflow and remote capture settings.
...
| Photo stand | [Kaiser Reprokid](https://www.kaiser-fototechnik.de/en/produkte/index.php?s=252){:target="_blank"} | 
...
The above information and the workflow included on this page are provided as suggestions based on PARADISEC-specific workflows; feel free to choose your own hardware and software.  
...
If you are affiliated with ANU, our workstation allows you to access this program using your university login. If you do not have access to the Adobe Creative Cloud suite of programs, you can still use <a href="https://www.adobe.com/au/products/bridge.html?mv=affiliate&mv2=red" target="_blank">Adobe Bridge</a>, but in order to use the Camera Raw function to edit your .CR2 files, you need to have a subscription to Photoshop. See the section below on <a href="https://paradisec-archive.github.io/PARADISEC_workflows/05_digitising_manuscripts.html#low-cost-options" target="_blank">Low-cost Options</a>for alternatives.
